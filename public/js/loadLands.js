    ...
    <div id="land-${land[3]}" class="w3-third">
        <div class="w3-card-4 property">
            ...
            <div style="text-align:center;padding-top:20px;">
                <button data-landid="${land[3]}" data-owner="${land[2]}" data-cost="${land[1]}" data-location="${land[0]}" class="w3-btn sell-property-button" style="background-color:#09f;color:#fff;">Sell Property</button>
            </div>
        </div>
    </div>
    `

    document.querySelector('.sell-property-button').addEventListener('click', sellProperty);
}
